package lessons.lesson6.fileutils;
...
public class YmlHandler {
    public static final Path SEAT_BOOKINGS_PATH = Paths.get(
        "src", "main", "java", "lessons", "lesson6", "filefolder", "seat-bookings.yml");

    public static void writeToYmlFile(SeatBookingMap seatBookingMap) {
        ...
        String output = yaml.dump(seatBookingMap);
        try {
    ...
    public static SeatBookingMap readFromYmlFile() {
        ...
        try (InputStreamReader reader = new InputStreamReader(
            ...
            Yaml yaml = new Yaml();
            SeatBookingMap map = yaml.loadAs(reader, SeatBookingMap.class);
